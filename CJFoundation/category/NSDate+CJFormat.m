...
@implementation NSDate (CJFormat)
...
- (NSString *)timeAgoSinceDate:(NSDate *)date shortformatting:(BOOL)shortFormatting {
    ...
    if (components.year >= 1) {
        ...
        componentValue = components.weekOfYear;
        componentName = (components.weekOfYear == 1) ? NSLocalizedString(@"week", nil) : NSLocalizedString(@"weeks", nil);
    }
